...
describe("parseSubAgentsRawList", () => {
    ...
    it("keeps valid entries with known model ids", () => {
        expect(parseSubAgentsRawList([{ name: "docs", model: "grok-4.3", instruction: "Focus on documentation." }])).toEqual([{ name: "docs", model: "grok-4.3", instruction: "Focus on documentation." }]);
    });
    it("normalizes aliases to canonical ids", () => {
        expect(parseSubAgentsRawList([
...
describe("getCurrentModel with modeModels", () => {
    ...
    it("respects mode-specific models when provided", () => {
        ...
        const result = getCurrentModel("agent");
...
//# sourceMappingURL=subagents-settings.test.js.map