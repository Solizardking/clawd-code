...
export function formatTelegramAudioTranscript(kind, transcript) {
...
export function buildTelegramAudioFileName(source, extension) {
...
function inferTelegramAudioExtension(source, filePath) {
