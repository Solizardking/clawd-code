...
export function getVerifyArtifacts() {
    return [
...
export function buildReadinessGuidance(profile) {
...
export function buildBrowserGuidance(profile) {
...
export function buildEvidenceGuidance() {
