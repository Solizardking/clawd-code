export declare const HOOK_EVENTS: readonly ["PreToolUse", "PostToolUse", "PostToolUseFailure", "UserPromptSubmit", "SessionStart", "SessionEnd", "Stop", "StopFailure", "SubagentStart", "SubagentStop", "TaskCreated", "TaskCompleted", "PreCompact", "PostCompact", "Notification", "InstructionsLoaded", "CwdChanged"];
...
export type HookInput = PreToolUseHookInput | PostToolUseHookInput | PostToolUseFailureHookInput | UserPromptSubmitHookInput | SessionStartHookInput | SessionEndHookInput | StopHookInput | StopFailureHookInput | SubagentStartHookInput | SubagentStopHookInput | TaskCreatedHookInput | TaskCompletedHookInput | PreCompactHookInput | PostCompactHookInput | NotificationHookInput | InstructionsLoadedHookInput | CwdChangedHookInput;
 ...
 */
export declare function getMatchQuery(input: HookInput): string | undefined;
