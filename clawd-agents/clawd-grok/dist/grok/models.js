 ...
 */
export const PROVIDERS = ["xai", "zai", "openai", "openrouter", "deepseek", "custom"];
...
export function isProviderId(value) {
    return Boolean(value && PROVIDERS.includes(value.toLowerCase()));
}
...
export function resolveModelRoute(modelId, provider) {
...
function parseModelProviderPrefix(id) {
    const trimmed = id.trim();
