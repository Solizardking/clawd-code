...
describe("Agent sandbox mode", () => {
    ...
    it("passes sandbox mode into background delegations", async () => {
        ...
        expect(startMock).toHaveBeenCalledWith(expect.objectContaining({ agent: "explore" }), expect.objectContaining({ sandboxMode: "shuru" }));
    });
    ...
    it("passes sandbox settings into background delegations", async () => {
        ...
        expect(startMock).toHaveBeenCalledWith(expect.objectContaining({ agent: "explore" }), expect.objectContaining({ sandboxSettings: settings }));
    });
});
