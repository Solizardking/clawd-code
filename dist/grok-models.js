 ...
 */
import { OPENROUTER_FABLE5, OPENROUTER_FABLE_LATESY, OPENROUTER_NEMO_MODEL1, OPENROUTER_NEMO_MODEL2, OPENROUTER_NEMO_MODEL3, } from './openrouter.js';
import { ZAI_DEFAULT_MODEL, ZAI_FAST_MODEL, ZAI_IMAGE_FALLBACK_MODEL, ZAI_IMAGE_MODEL, ZAI_TRADE_VISION_MODEL, ZAI_VISION_FAST_MODEL, ZAI_VISION_MODEL, } from './zai.js';
...
export function printModelsTable() {
    const providers = ['zai', 'xai', 'anthropic', 'deepseek', 'openrouter'];
    const labels = {
