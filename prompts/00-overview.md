# Clawd Code Build-Out Prompt Index

Run these prompts **in order** in separate AI agent sessions. Each one is self-contained and independently verifiable.
...
| 08 | `08-command-system.md` | Audit and wire up the 50+ slash commands (/help, /wallet, /perps, /arena, etc.) | 01–03, 07 |
...
1. Open a new AI coding session (Claude Code, Copilot, etc.)
